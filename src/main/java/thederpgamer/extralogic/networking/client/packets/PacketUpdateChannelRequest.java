 ...
 */
public class PacketUpdateChannelRequest extends Packet {

	private LinkChannel channel;

	public PacketUpdateChannelRequest() {

	}

	public PacketUpdateChannelRequest(LinkChannel channel) {
	...
	public void processPacketOnServer(PlayerState playerState) {
		for(PlayerState player : GameServer.getServerState().getPlayerStatesByName().values()) {
			if(!player.equals(playerState)) {
				PacketUtil.sendPacket(player, new PacketUpdateChannelResponse(channel));
			}
		}
	}
}
